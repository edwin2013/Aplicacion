    ...
    this.consultarDatosUsuario = function () {
        $.ajax({
            ...
            success: function (data) {
                ...
                mostrarFuncionalidades(usuario.ListaFuncionalidades, usuario.UsuarioId);
...
function mostrarFuncionalidades(listaFuncionalidades, usuarioId) {

    $.each(listaFuncionalidades, function (index, item) {
        var noPoseePermiso = item.Permiso == false;

        if (noPoseePermiso) {
            var esTipoOcultar = item.Tipo == 'Ocultar';
